  ...
  def __init__(
    ...
    if self.config.backbone == 'cnn':
      ...
      self.backbone = models.dimamba.DiMamba(
        self.config, vocab_size=self.vocab_size, pad_token_id=self.mask_index)
    else:
      raise ValueError(
    ...
    # subset of data for evaluation (oracle-based eval disabled for narry_kim)
  ...
  def on_validation_epoch_end(self):
    if ((self.config.eval.compute_perplexity_on_sanity
      ...
      for _ in range(
        ...
        detokenized_samples = dataloader.batch_dna_detokenize(samples)
